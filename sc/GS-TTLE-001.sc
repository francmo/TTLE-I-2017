...
// identificazione motore audio
ServerOptions.devices;
ServerOptions.inDevices;
ServerOptions.outDevices;

// gestione motore audio
Server.local.options.device = ServerOptions.inDevices[0];
Server.local.options.device = ServerOptions.outDevices[1];

// Gestione Frequenza Campionamento (MIXER MASTER)
